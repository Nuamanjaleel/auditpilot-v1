...
# ─── CUSTOM CSS (CLEAN & NON-DESTRUCTIVE) ─────────────────────
st.markdown("""
<style>
...
if "results_df" in st.session_state:
    ...
    with chart_col1:
        ...
        fig_donut.update_layout(margin=dict(t=40, b=0, l=0, r=0), height=300, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)", font=dict(color="#E6EDF3"))
    ...
    with chart_col2:
        ...
        fig_bar.update_layout(margin=dict(t=40, b=0, l=0, r=0), height=300, showlegend=False, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)", font=dict(color="#E6EDF3"))
